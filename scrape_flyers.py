"""
scrape_flyers.py — Jumbo Flyers Heerenveen (ijshockey) thuiswedstrijden

Gebruik:
    python scrape_flyers.py              # scrape, sla op in DB
    python scrape_flyers.py --dry-run    # toon events zonder op te slaan
...
"schema 2026-2027 nog niet gepubliceerd"; bleek inmiddels wel gepubliceerd
(herchecked 2026-09-02, via de gedeelde hockeydata.net Eredivisie-feed,
gevonden bij het onderzoeken van scrape_grizzlys.py — unisflyers.nl zelf
hoefde niet eens bezocht te worden).
"""
...
def scrape(dry_run: bool = False) -> tuple[int, int]:
    ...
    for r in rows:
        ...
        ev = {
            ...
            'url':    'https://www.unisflyers.nl/wedstrijden/',
            'source': SOURCE,
            'genre':  'sport',
            'sport':  'ijshockey',
            'gender': 'heren',
