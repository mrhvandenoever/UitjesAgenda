"""
scrape_goahead.py — Go Ahead Eagles thuiswedstrijden via ESPN.nl

Gebruik:
    python scrape_goahead.py              # scrape, sla op in DB
    python scrape_goahead.py --dry-run    # toon events zonder op te slaan
...
LET OP (uit scraping_recipes.json): ID moet 3706 zijn, niet 3769.
"""
