"""
scrape_peczwolle.py — PEC Zwolle thuiswedstrijden via ESPN.nl

Gebruik:
    python scrape_peczwolle.py              # scrape, sla op in DB
    python scrape_peczwolle.py --dry-run    # toon events zonder op te slaan
...
LET OP (uit scraping_recipes.json): ESPN-slug is ned.fc_zwolle, niet ned.pec_zwolle.
"""
...
SOURCE = 'peczwolle'
CLUB   = 'PEC Zwolle'
VENUE  = 'MAC3PARK Stadion, Zwolle'
URL    = 'https://www.espn.nl/voetbal/team/speelkalender/_/id/2565/ned.fc_zwolle'
