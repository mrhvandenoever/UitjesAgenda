"""
scrape_friso.py — Friso Sneek (volleybal, dames 1) via Nevobo RSS

Gebruik:
    python scrape_friso.py              # scrape, sla op in DB
    python scrape_friso.py --dry-run    # toon events zonder op te slaan

Zelfde aanpak als scrape_lycurgus.py (zie die docstring) — bewust een losse
kopie per club, zie ARCHITECTURE.md §Scrapers-conventie. Teamcode ckl6l98
(dames/1).
"""
...
CLUB_NAME = 'Friso'
VENUE     = 'Sneek'
FEED_URL  = 'https://api.nevobo.nl/export/team/ckl6l98/dames/1/programma.rss'
