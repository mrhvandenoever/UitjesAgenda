"""
scrape_landstede.py — Landstede Hammers (basketbal, BNXT League) thuiswedstrijden

Gebruik:
    python scrape_landstede.py              # scrape, sla op in DB
    python scrape_landstede.py --dry-run    # toon events zonder op te slaan
...
scrape_donar.py is de bijna-identieke tweelingbroer (zelfde API, andere
...
SOURCE       = 'landstede'
CLUB_NAME    = 'Landstede'
DEFAULT_VENUE = 'Landstede Sportcentrum, Zwolle'
TICKET_URL   = 'https://www.landstedehammers.nl'
